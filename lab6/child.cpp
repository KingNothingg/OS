...
int main(int argc, char **argv){
    ...
    zmqpp::socket parentSocket(context, zmqpp::socket_type::rep);

    parentSocket.connect(host + std::to_string(parentPort));

    zmqpp::socket leftSocket(context, zmqpp::socket_type::req);
    zmqpp::socket rightSocket(context, zmqpp::socket_type::req);
